...
<div id="create-coa">
  ...
  <div class="container max-w-full px-2 bg-white py-6 sm:py-8 lg:py-12 flex items-center flex-col">
      ...
      <div class="text-gray-800 xs:block grid grid-cols-2 gap-7 max-w-6xl w-full top-border pt-4 xs:px-1 sm:px-2 md:px-3">
        ...
        <div class="w-full max-w-xl flex flex-col justify-center items-center xs:h-40">
          ...
          <div class="rounded border bg-gray-50 cursor-pointer shrink grow w-full h-full" v-else>
              <div class="flex flex-col items-center justify-center w-full h-full hover:bg-gray-100 hover:border-gray-300">
                ...
                <p class="absolute mt-14 text-sm text-slightGay tracking-wider select-none text-gray-400 group-hover:text-gray-600">
                  Select Artwork photo
                </p>
                <p class="absolute mt-24 text-sm text-slightGay tracking-wider select-none text-gray-400 group-hover:text-gray-600">
                  and drag here
                </p>
...
<!--          <div class="mt-2">-->
<!--            <input required v-model="createdAt" type="date" placeholder="Creation date" class="w-full bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25" />-->
<!--          </div>-->
          ...
          <div class="mt-2">
            <date-picker
                ...
                clearable
                class="w-full"
                input-class="w-full bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25"
            ></date-picker>
        </div>
          ...
          <div class="flex flex-row justify-around items-center flex-wrap mt-2">
            <div class="flex flex-row items-center">
              <input type="checkbox" required v-model='isUnique'>
              <label class="text-slightGay ml-2 inline-block text-sm sm:text-base">Unique</label>
            </div>
            <div class="flex flex-row items-center">
              <input type="checkbox" required v-model='isExtraSelected'>
            </div>
            <input :disabled="!isExtraSelected" v-model="serie_name" placeholder="Serie name" class="bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25" />
            <InfoIcon/>
          </div>
          ...
          <div class="mt-1 flex flex-row items-baseline justify-around xs:justify-around flex-wrap">
            <input :disabled="!isExtraSelected" v-model="numbering" placeholder="Numbering" class="bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25" />
            <p class="text-slightGay">out of</p>
            <input :disabled="!isExtraSelected" v-model="total_quantity" placeholder="Total quantity" class="xs:mt-2 sm:mt-2 bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25" />
          </div>
          ...
          <div class="top-border low-border mt-3 pb-2 flex flex-col">
            <p class="text-orange mt-1">AFT on behalf of the Artist</p>
            <div class="flex items-center">
              <input required v-model="artist_email" placeholder="Artist email" class="w-full mt-1 bg-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2 placeholder-gray-500 placeholder-opacity-25" />
