    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
      ...
      <div>
        ...
        <nav class="flex flex-col gap-4">
          <div>
            <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">about Us</a>
          </div>

          <div>
            <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Contact Us</a>
          </div>
        </nav>
      </div>
      <!-- nav - end -->
      ...
      <div>
        ...
        <nav class="flex flex-col gap-4">
          ...
          <div>
            <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Help</a>
          </div>
      ...
      <div>
        ...
        <nav class="flex flex-col gap-4">
          <div>
            <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Terms & Conditions</a>
          </div>
          ...
          <div>
            <a href="#" class="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Terms of use</a>
          </div>
        </nav>
      </div>
      <!-- nav - end -->
